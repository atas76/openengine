...
public class TacticalBehaviour442GlobalPassingTest {
    ...
    public void testLeftBackActionsProbabilisticAssertions() {
        ...
        assertEquals(0.2 * xP / 2.8, testOutput.getPossessionOutcomeByPosition(Position.M_CL), DELTA);
        assertEquals(0.2 * xP / 5.6, testOutput.getPossessionOutcomeByPosition(Position.F_CL), DELTA);
    }
    ...
    public void testCentreRightBackProbabilisticAssertions() {
        ...
        assertEquals(0.17 * xP / 2.0, testOutput.getPossessionOutcomeByPosition(Position.M_CR), DELTA);
        assertEquals(0.17 * xP / 2.0, testOutput.getPossessionOutcomeByPosition(Position.M_R), DELTA);
        assertEquals(0.17 * xP / 4.0, testOutput.getPossessionOutcomeByPosition(Position.F_CR), DELTA);
    }
    ...
    public void testCentreLeftBackProbabilisticAssertions() {
        ...
        assertEquals(0.17 * xP / 2.0, testOutput.getPossessionOutcomeByPosition(Position.M_CL), DELTA);
        assertEquals(0.17 * xP / 2.0, testOutput.getPossessionOutcomeByPosition(Position.M_L), DELTA);
        assertEquals(0.17 * xP / 4.0, testOutput.getPossessionOutcomeByPosition(Position.F_CL), DELTA);
    }
    ...
    public void testRightMidfielderActionsProbabilisticAssertions() {
        ...
        assertEquals(xP * 0.5 / 2.8, testOutput.getPossessionOutcomeByPosition(Position.F_CR), DELTA);
    }
