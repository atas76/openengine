...
public class TacticalBehaviour442GlobalPassingTest {
    ...
    public void testGoalkeeperActionsProbabilisticAssertions() {
        ...
        assertEquals(0.033 * xP, testOutput.getPossessionOutcomeByPosition(Position.F_CR), DELTA);
        assertEquals(0.033 * xP, testOutput.getPossessionOutcomeByPosition(Position.F_CL), DELTA);
    }
    ...
    public void testRightBackActionsProbabilisticAssertions() {
        ...
        assertEquals(0.2 * xP, testOutput.getPossessionOutcomeByPosition(Position.M_R), DELTA);
    ...
    public void testLeftBackActionsProbabilisticAssertions() {
        ...
        assertEquals(0.2 * xP, testOutput.getPossessionOutcomeByPosition(Position.M_L), DELTA);
    ...
    public void testCentreRightBackProbabilisticAssertions() {
        ...
        assertEquals(0.17 * xP / 1.4, testOutput.getPossessionOutcomeByPosition(Position.M_R), DELTA);
