...
public class TacticalBehaviour442vs433GlobalPassingTest {
    ...
    public void testGoalkeeperActionsProbabilisticAssertions() {
        ...
        assertEquals(0.1 * xP / (getUnitFactor(VERTICAL_DISTANCE_WEIGHT * 0.5) * getUnitFactor(HORIZONTAL_DISTANCE_WEIGHT * 0.5)),
                testOutput.getPossessionOutcomeByPosition(Position.M_R), DELTA);
        assertEquals(0.1 * xP / HORIZONTAL_DISTANCE_UNIT_FACTOR,
        ...
        assertEquals(0.1 * xP / (VERTICAL_DISTANCE_UNIT_FACTOR * HORIZONTAL_DISTANCE_UNIT_FACTOR * 2),
    ...
    public void testRightBackActionsProbabilisticAssertions() {
        ...
        assertEquals(0.2 * xP / (HORIZONTAL_DISTANCE_UNIT_FACTOR * VERTICAL_DISTANCE_UNIT_FACTOR),
                testOutput.getPossessionOutcomeByPosition(Position.M_CR), DELTA);
        assertEquals(0.2 * xP / (HORIZONTAL_DISTANCE_UNIT_FACTOR * VERTICAL_DISTANCE_UNIT_FACTOR * 2),
                testOutput.getPossessionOutcomeByPosition(Position.F_CR), DELTA);
    }
    ...
    public void testCentreLeftBackProbabilisticAssertions() {
        ...
        assertEquals(0.17, testOutput.getPossessionOutcomeByPosition(Position.GK), DELTA);
        assertEquals(0.17 * xP, testOutput.getPossessionOutcomeByPosition(Position.D_L), DELTA);
    ...
    public void testRightMidfielderActionsProbabilisticAssertions() {
        ...
        assertEquals(xP * 0.5 / (VERTICAL_DISTANCE_UNIT_FACTOR * HORIZONTAL_DISTANCE_UNIT_FACTOR),
                testOutput.getPossessionOutcomeByPosition(Position.F_CR), DELTA);
    }
