...
public class TacticalBehaviour433GlobalPassingTest {
    ...
    public void testCentreLeftDefenderActionsProbabilisticAssertions() {
        ...
        assertEquals(0.14 * xP, testOutput.getPossessionOutcomeByPosition(Position.M_C), DELTA);
        assertEquals(0.14 * xP, testOutput.getPossessionOutcomeByPosition(Position.M_LC), DELTA);
        assertEquals(0.14 * xP / 2, testOutput.getPossessionOutcomeByPosition(Position.F_LC), DELTA);
        assertEquals(0.14 * xP / 2, testOutput.getPossessionOutcomeByPosition(Position.F_C), DELTA);
    }
    ...
    public void testRightCentreMidfielderActionsProbabilisticAssertions() {
        ...
        assertEquals(0.33 * xP / 1.4, testOutput.getPossessionOutcomeByPosition(Position.F_C), DELTA);
    }
    ...
    public void testMidfielderActionsProbabilisticAssertions() {
        ...
        assertEquals(0.2 * xP, testOutput.getPossessionOutcomeByPosition(Position.F_C), DELTA);
        assertEquals(0.2 * xP, testOutput.getPossessionOutcomeByPosition(Position.F_RC), DELTA);
        assertEquals(0.2 * xP, testOutput.getPossessionOutcomeByPosition(Position.F_LC), DELTA);
    }
