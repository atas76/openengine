        ...
        switch(tactics) {
            case _4_4_2 -> {
                ...
                leftBack.setPermissibleActions(Arrays.asList(
                        ...
                        new Action(rightBack, this.formation.get(Position.M_CL), ActionType.Pass, 2.0 * 1.4),
                        new Action(rightBack, this.formation.get(Position.F_CL), ActionType.Pass, 4.0 * 1.4)
                ));
                ...
                rightMidfielder.setPermissibleActions(Arrays.asList(
                        ...
                        new Action(rightMidfielder, this.formation.get(Position.F_CR), ActionType.Pass, 2.0 * 1.4)
                ));
                ...
                leftMidfielder.setPermissibleActions(Arrays.asList(
                        ...
                        new Action(rightMidfielder, this.formation.get(Position.F_CL), ActionType.Pass, 2.0 * 1.4)
                ));
                ...
                centreRightMidfielder.setPermissibleActions(Arrays.asList(
                        ...
                        new Action(centreRightMidfielder, this.formation.get(Position.F_CR), ActionType.Pass, 2.0)
                ));
                ...
                centreLeftMidfielder.setPermissibleActions(Arrays.asList(
                        ...
                        new Action(centreLeftMidfielder, this.formation.get(Position.F_CL), ActionType.Pass, 2.0)
                ));
