...
public class MatchFlowMatrixRepository {
    ...
    public static void loadHomeTeam() {
        ...
        L_CLF19.addRow(POSSESSION,
                new MatchSequence(new MatchPhaseTransition[] {
                        new MatchPhaseTransition(INTERCEPTION, false, 11, 0, 0),
                        new MatchPhaseTransition(CORNER_KICK, true, 24, 0, 0),
                        new MatchPhaseTransition(THROW_IN, false, 37, 0, 0),
                        new MatchPhaseTransition(THROW_IN, false, 7, 0, 0),
                        new MatchPhaseTransition(THROW_IN, true, 8, 0, 0),
                        new MatchPhaseTransition(THROW_IN, true, 11, 0, 0),
                        new MatchPhaseTransition(PRESSURE, true, 8, 0, 0),
                        new MatchPhaseTransition(PRESSURE, true, 19, 0, 0),
                        new MatchPhaseTransition(FREE_KICK, true, 19, 0, 0),
                        new MatchPhaseTransition(FREE_KICK, false, 10, 0, 0),
                        ...
                        new MatchPhaseTransition(COUNTER_ATTACK, false, 37, 37, 0), // for now duration = breakTime
                        new MatchPhaseTransition(TRANSITION, false, 7, 0, 0),
                }));
        L_CLF19.addRow(TRANSITION,
                new MatchSequence(new MatchPhaseTransition[] {
                        new MatchPhaseTransition(THROW_IN, false, 13, 0, 0),
                        new MatchPhaseTransition(DEFENSIVE_TRANSITION, false, 17, 17, 0),
                        new MatchPhaseTransition(DEFENSIVE_TRANSITION, false, 23, 0, 0),
                        new MatchPhaseTransition(TRANSITION, false, 9, 0, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 87, 0, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 19, 0, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 44, 0, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 10, 0, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 9, 0, 0),
                        new MatchPhaseTransition(ATTACKING_POSSESSION, true, 5, 0, 0),
                        new MatchPhaseTransition(POSSESSION, false, 36, 0, 0),
                        new MatchPhaseTransition(POSSESSION, false, 12, 0, 0),
                        new MatchPhaseTransition(POSSESSION, false, 12, 0, 0)
                }));
        L_CLF19.addRow(ATTACKING_TRANSITION,
                new MatchSequence(new MatchPhaseTransition[] {
                        ...
                        new MatchPhaseTransition(ATTACKING_POSSESSION, true, 3, 0, 0),
                        new MatchPhaseTransition(ATTACKING_POSSESSION, true, 5, 0, 0),
                        new MatchPhaseTransition(PENALTY, true, 0, 0, 0),
                        new MatchPhaseTransition(PRESSURE, false, 16, 0, 0),
                        new MatchPhaseTransition(PRESSURE, false, 10, 0, 0),
                        new MatchPhaseTransition(ATTACK, true, 13, 0, 0)
                }));
        ...
        L_CLF19.addRow(THROW_IN,
                new MatchSequence(new MatchPhaseTransition[] {
                        new MatchPhaseTransition(POSSESSION, true, 29, 0, 0),
                        new MatchPhaseTransition(THROW_IN, false, 35, 0, 0),
                        new MatchPhaseTransition(THROW_IN, false, 2, 0, 0),
                        new MatchPhaseTransition(THROW_IN, false, 3, 0, 0),
                        new MatchPhaseTransition(THROW_IN, true, 11, 0, 0),
                        new MatchPhaseTransition(THROW_IN, true, 20, 0, 0),
                        new MatchPhaseTransition(THROW_IN, true, 18, 0, 0),
                        new MatchPhaseTransition(DEFENSIVE_TRANSITION, false, 5, 0, 0),
                        new MatchPhaseTransition(DEFENSIVE_TRANSITION, false, 49, 0, 0),
                        new MatchPhaseTransition(DEFENSIVE_TRANSITION, false, 6, 0, 0),
                        new MatchPhaseTransition(TRANSITION, false, 5, 0, 0),
                        new MatchPhaseTransition(TRANSITION, false, 9, 0, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 81, 81, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 5, 0, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, true, 34, 34, 0),
                        new MatchPhaseTransition(POSSESSION, false, 23, 0, 0),
                        new MatchPhaseTransition(POSSESSION, false, 13, 0, 0),
                        new MatchPhaseTransition(POSSESSION, false, 6, 0, 0),
                        new MatchPhaseTransition(ATTACK, true, 39, 0, 0),
                        new MatchPhaseTransition(TRANSITION, true, 26, 26, 0),
                        new MatchPhaseTransition(ATTACKING_TRANSITION, false, 12, 0, 0),
                        new MatchPhaseTransition(ATTACKING_POSSESSION, false, 14, 0, 0),
                        new MatchPhaseTransition(FREE_KICK, true, 3, 0, 0)
                }));
        L_CLF19.addRow(ATTACKING_POSSESSION,
                new MatchSequence(new MatchPhaseTransition[] {
                        new MatchPhaseTransition(ATTACK, true, 55, 55, 0),
                        new MatchPhaseTransition(ATTACK, true, 20, 0, 0),
                        new MatchPhaseTransition(ATTACK, true, 15, 15, 0),
                }));
